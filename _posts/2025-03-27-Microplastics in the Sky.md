---
layout: post
title: Microplastics in the Sky - How Tiny Plastic Particles Might Be Shaping Clouds and Climate
date: 2025-03-27 22:07:48
...
<div class="row justify-content-sm-center">
    <div class="col-sm-8 mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/Nanoplastics in Cloud.png" title="Illustration of nano-plastic particles (PVC and PET) absorbing water, becoming aerosolized, and contributing to wet deposition through precipitation." class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
A conceptual diagram showing how nano-plastics (PVC and PET) take up water in the atmosphere, leading to aerosolization and eventual wet deposition via rain or snow. Image from {% cite mao2024hygroscopicity %}.
</div>

## Nano-Plastics: Unexpected Cloud Seeders

The first study, led by {% cite mao2024hygroscopicity %}, tackles a critical question: Can nano-sized plastic particles act as cloud condensation nuclei (CCN)? Using aerosol techniques like **scanning mobility particle sizers (SMPS)** and **cloud condensation nuclei counters (CCNC)**, the team measured the hygroscopicity (water-absorbing ability) of three common plastics: low-density polyethylene (LDPE), polyethylene terephthalate (PET), and polyvinyl chloride (PVC). They compared these to cellulose, a natural polymer found in paper.
...
The second paper by {% cite wang2023airborne %} takes us to the skies, literally. The team collected cloud water from mountaintops in Japan, including Mt. Fuji (3,776 meters), and analyzed it using **micro-Fourier transform infrared spectroscopy (µFTIR)**. They found microplastics in _every sample_, with concentrations up to 13.9 pieces per liter. The culprits? Fragments of PET, polypropylene, polyamide, and even epoxy resin.
...
But there are caveats. {% cite mao2024hygroscopicity %}’s experiments used lab generated nano-plastics, which might behave differently than real world particles degraded by UV or pollution. {% cite wang2023airborne %}’s cloud samples had low plastic concentrations; does this translate to a meaningful climate impact? More fieldwork is needed to quantify the scale of this phenomenon.
