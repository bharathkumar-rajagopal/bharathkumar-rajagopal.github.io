...
<div class="row justify-content-sm-center">
    <div class="col-sm-8 mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/Microplastic Biofilm and associated pollution.png" title="Diagram showing microplastics undergoing weathering, transporting pollutants like heavy metals and organic contaminants, forming biofilms that enrich harmful microorganisms and antibiotics, ultimately impacting ecosystems." class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
